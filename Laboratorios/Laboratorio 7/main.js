...
let schedule_dropdrown = document.querySelector('#schedule_field')
let late_switch = document.querySelector('#late_switch')
let submit_btn = document.querySelector('#submit_btn')

let table_doby = document.querySelector('#table_body')
...
let addStudent = (carnet, schedule,late)=> {
    ...
    table_doby.appendChild(new_row)
}
...
submit_btn.addEventListener('click', ()=>{
    ...
    let schedule = schedule_dropdrown.options[schedule_dropdrown.selectedIndex].text
